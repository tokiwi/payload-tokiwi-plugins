...
A package directory is self-contained — its own `package.json`, build and tests. It never
...
a release pull request; merging that one publishes. Never publish by hand, never bump a
